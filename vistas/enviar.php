<?php
    ...
    try {
        ...
        $mailResAu->isSMTP(true);                                            //Send using SMTP
        ...
        $mailResAu->SMTPSecure = 'tls';            //Enable implicit TLS encryption
        $mailResAu->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
